            ...
            <div class="col-md-6 col-sm-12">
               <div class="content">
                ...
                <div class="text-bawah">
                    <h3 class="text-satu my-3">Tentang Kami</h3>
                    <h3 class="text-dua my-3"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                        ...
                        </svg> Jl. Paccinongan Lr. 4 - Gowa</h3>
                    <h3 class="text-tiga">
