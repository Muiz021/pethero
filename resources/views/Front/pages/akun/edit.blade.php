...
<section id="daftar">
    <div class="container">
        <div class="d-flex justify-content-center pt-5">
            ...
            <img src="{{ asset('back/img/avatars/1.png') }}" class="rounded-circle" width="150px" alt="">
        </div>
        <div class="d-flex justify-content-center pt-3">
            <h4 class="text-uppercase">{{Auth::user()->nama}}</h4>
        </div>
        <form class="form mx-3 mt-3" action="{{route('front.update',$akun->slug)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="mb-3">
