                    ...
                    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset('front/img/carousel/menu-1.png') }}" class="d-block w-100"
                                    alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('front/img/carousel/menu-2.png') }}" class="d-block w-100"
                                    alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('front/img/carousel/menu-3.png') }}" class="d-block w-100"
                                    alt="...">
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-sm-12" style="padding: 0;">
                <div class="content">
                    <div class="text-tengah">
                        ...
                        <p class="deskripsi">Kami memahami bahwa hewan peliharaan Anda adalah anggota keluarga yang
                            penting bagi
                            Anda, sehingga kami akan melakukan yang terbaik untuk memastikan keselamatan dan kenyamanan
                            hewan
                            ...
                            <div class="d-flex flex-column">
                                @if (Auth::user())
                                    <a href="{{ route('front.kirim-hewan1') }}" class="my-2">
                                        <img src="{{ asset('front/img/menu/menu-1.png') }}" width="100%"
                                            alt="">
                                    </a>
                                @else
                                    <a href="{{ route('masuk') }}"
                                        onclick="return confirm('Silahkan Login Terlebih Dahulu');" class="my-2">
                                        <img src="{{ asset('front/img/menu/menu-1.png') }}" width="100%"
                                            alt="">
                                    </a>
                                @endif
